                            ...
                            <div class='tab-pane fade' id='4a'>         
                             <div class='tm-recommended-place-wrap'>   
                              ...
                              <tr>
                                 ...
                                 <td> </td>
                                 <td> </td>
                                 <td> <a href='supprimeroffre1.php?id_offre={$data['id_offre']}'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp                                                          <input type='submit' name='supprimer' value='Supprimer' class='text-uppercase btn-primary tm-btn'>          </a></td>
